...
package com.newstoday.nepalnews.news_package.news_category.world.fragment;
...
import com.newstoday.nepalnews.news_package.news_category.world.adapter.EntriesCursorAdapter;
...
import com.newstoday.nepalnews.news_package.news_category.world.service.FetcherService;
...
public class EntriesListFragment extends SwipeRefreshListFragment implements ViewTreeObserver.OnScrollChangedListener {
    ...
    public void inflateView(LayoutInflater inflater, ViewGroup container) {
        ...
        News_Sites_Adapter adapter = new News_Sites_Adapter(getActivity(), "worldnewssites", MainActivity.topNewsSites, MainActivity.entertainmentnewssites, MainActivity.financenewssites, MainActivity.healthnewssites, MainActivity.politicsnewssites, MainActivity.sportsnewssites, MainActivity.technologynewssites,
