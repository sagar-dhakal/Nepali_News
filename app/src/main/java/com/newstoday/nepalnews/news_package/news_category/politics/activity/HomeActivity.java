...
package com.newstoday.nepalnews.news_package.news_category.politics.activity;
...
import com.newstoday.nepalnews.news_package.news_category.politics.fragment.EntriesListFragment;
import com.newstoday.nepalnews.news_package.news_category.politics.provider.FeedData.EntryColumns;
import com.newstoday.nepalnews.news_package.news_category.politics.provider.FeedData.FeedColumns;
import com.newstoday.nepalnews.news_package.news_category.politics.provider.FeedDataContentProvider;
import com.newstoday.nepalnews.news_package.news_category.politics.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_politics_view_home);
        ...
        String url1 = MainActivity.politicsrssLinks.get(i).rssLink1;
        String url2 = MainActivity.politicsrssLinks.get(i).rssLink2;
        String url3 = MainActivity.politicsrssLinks.get(i).rssLink3;
        String url4 = MainActivity.politicsrssLinks.get(i).rssLink4;
        String url5 = MainActivity.politicsrssLinks.get(i).rssLink5;
        String url6 = MainActivity.politicsrssLinks.get(i).rssLink6;
        String url7 = MainActivity.politicsrssLinks.get(i).rssLink7;
        String url8 = MainActivity.politicsrssLinks.get(i).rssLink8;
        String url9 = MainActivity.politicsrssLinks.get(i).rssLink9;
        String url10 = MainActivity.politicsrssLinks.get(i).rssLink10;
        String url11 = MainActivity.politicsrssLinks.get(i).rssLink11;
        String url12 = MainActivity.politicsrssLinks.get(i).rssLink12;
        String url13 = MainActivity.politicsrssLinks.get(i).rssLink13;
        String url14 = MainActivity.politicsrssLinks.get(i).rssLink14;
        String url15 = MainActivity.politicsrssLinks.get(i).rssLink15;
