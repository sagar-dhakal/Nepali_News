...
package com.newstoday.nepalnews.news_package.news_category.entertainment.activity;
...
import com.newstoday.nepalnews.news_package.news_category.entertainment.fragment.EntriesListFragment;
...
import com.newstoday.nepalnews.news_package.news_category.entertainment.provider.FeedDataContentProvider;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_entertainment_view_home);
        ...
        String url1 = MainActivity.entertainmentrssLinks.get(i).rssLink1;
        String url2 = MainActivity.entertainmentrssLinks.get(i).rssLink2;
        String url3 = MainActivity.entertainmentrssLinks.get(i).rssLink3;
        String url4 = MainActivity.entertainmentrssLinks.get(i).rssLink4;
        String url5 = MainActivity.entertainmentrssLinks.get(i).rssLink5;
        String url6 = MainActivity.entertainmentrssLinks.get(i).rssLink6;
        String url7 = MainActivity.entertainmentrssLinks.get(i).rssLink7;
        String url8 = MainActivity.entertainmentrssLinks.get(i).rssLink8;
        String url9 = MainActivity.entertainmentrssLinks.get(i).rssLink9;
        String url10 = MainActivity.entertainmentrssLinks.get(i).rssLink10;
        String url11 = MainActivity.entertainmentrssLinks.get(i).rssLink11;
        String url12 = MainActivity.entertainmentrssLinks.get(i).rssLink12;
        String url13 = MainActivity.entertainmentrssLinks.get(i).rssLink13;
        String url14 = MainActivity.entertainmentrssLinks.get(i).rssLink14;
        String url15 = MainActivity.entertainmentrssLinks.get(i).rssLink15;
