...
package com.newstoday.nepalnews.news_package.news_category.finance.activity;
...
import com.newstoday.nepalnews.news_package.news_category.finance.fragment.EntriesListFragment;
import com.newstoday.nepalnews.news_package.news_category.finance.provider.FeedData.EntryColumns;
import com.newstoday.nepalnews.news_package.news_category.finance.provider.FeedData.FeedColumns;
import com.newstoday.nepalnews.news_package.news_category.finance.provider.FeedDataContentProvider;
import com.newstoday.nepalnews.news_package.news_category.finance.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_finance_view_home);
        ...
        String url1 = MainActivity.financerssLinks.get(i).rssLink1;
        String url2 = MainActivity.financerssLinks.get(i).rssLink2;
        String url3 = MainActivity.financerssLinks.get(i).rssLink3;
        String url4 = MainActivity.financerssLinks.get(i).rssLink4;
        String url5 = MainActivity.financerssLinks.get(i).rssLink5;
        String url6 = MainActivity.financerssLinks.get(i).rssLink6;
        String url7 = MainActivity.financerssLinks.get(i).rssLink7;
        String url8 = MainActivity.financerssLinks.get(i).rssLink8;
        String url9 = MainActivity.financerssLinks.get(i).rssLink9;
        String url10 = MainActivity.financerssLinks.get(i).rssLink10;
        String url11 = MainActivity.financerssLinks.get(i).rssLink11;
        String url12 = MainActivity.financerssLinks.get(i).rssLink12;
        String url13 = MainActivity.financerssLinks.get(i).rssLink13;
        String url14 = MainActivity.financerssLinks.get(i).rssLink14;
        String url15 = MainActivity.financerssLinks.get(i).rssLink15;
