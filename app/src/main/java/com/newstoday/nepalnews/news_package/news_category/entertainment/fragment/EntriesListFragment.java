...
import com.newstoday.nepalnews.news_package.news_category.entertainment.adapter.EntriesCursorAdapter;
...
public class EntriesListFragment extends SwipeRefreshListFragment implements ViewTreeObserver.OnScrollChangedListener {
    ...
    public void inflateView(LayoutInflater inflater, ViewGroup container) {
        ...
        News_Sites_Adapter adapter = new News_Sites_Adapter(getActivity(), "entertainmentnewssites", MainActivity.topNewsSites, MainActivity.entertainmentnewssites, MainActivity.financenewssites, MainActivity.healthnewssites, MainActivity.politicsnewssites, MainActivity.sportsnewssites, MainActivity.technologynewssites,
