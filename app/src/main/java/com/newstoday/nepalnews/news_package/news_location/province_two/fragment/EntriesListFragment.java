...
package com.newstoday.nepalnews.news_package.news_location.province_two.fragment;
...
import com.newstoday.nepalnews.news_package.news_location.province_two.adapter.EntriesCursorAdapter;
import com.newstoday.nepalnews.news_package.news_location.province_two.provider.FeedData;
...
import com.newstoday.nepalnews.news_package.news_location.province_two.service.FetcherService;
...
public class EntriesListFragment extends SwipeRefreshListFragment implements ViewTreeObserver.OnScrollChangedListener {
    ...
    public void inflateView(LayoutInflater inflater, ViewGroup container) {
        ...
        News_Sites_Adapter adapter = new News_Sites_Adapter(getActivity(), "province2newssites", MainActivity.topNewsSites, MainActivity.entertainmentnewssites, MainActivity.financenewssites, MainActivity.healthnewssites, MainActivity.politicsnewssites, MainActivity.sportsnewssites, MainActivity.technologynewssites,
