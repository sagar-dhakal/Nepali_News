...
package com.newstoday.nepalnews.news_package.news_category.health.utils;
...
public class PrefUtils {
    ...
    public static final String FIRST_OPEN = "FIRST_OPEN_HEALTH";
    public static final String IS_REFRESHING = "IS_REFRESHING_HEALTH";
