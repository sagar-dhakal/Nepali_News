...
package com.newstoday.nepalnews.news_package.news_category.sports.activity;
...
import com.newstoday.nepalnews.news_package.news_category.sports.fragment.EntriesListFragment;
...
import com.newstoday.nepalnews.news_package.news_category.sports.provider.FeedDataContentProvider;
import com.newstoday.nepalnews.news_package.news_category.sports.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_sports_view_home);
        ...
        String url1 = MainActivity.sportsrssLinks.get(i).rssLink1;
        String url2 = MainActivity.sportsrssLinks.get(i).rssLink2;
        String url3 = MainActivity.sportsrssLinks.get(i).rssLink3;
        String url4 = MainActivity.sportsrssLinks.get(i).rssLink4;
        String url5 = MainActivity.sportsrssLinks.get(i).rssLink5;
        String url6 = MainActivity.sportsrssLinks.get(i).rssLink6;
        String url7 = MainActivity.sportsrssLinks.get(i).rssLink7;
        String url8 = MainActivity.sportsrssLinks.get(i).rssLink8;
        String url9 = MainActivity.sportsrssLinks.get(i).rssLink9;
        String url10 = MainActivity.sportsrssLinks.get(i).rssLink10;
        String url11 = MainActivity.sportsrssLinks.get(i).rssLink11;
        String url12 = MainActivity.sportsrssLinks.get(i).rssLink12;
        String url13 = MainActivity.sportsrssLinks.get(i).rssLink13;
        String url14 = MainActivity.sportsrssLinks.get(i).rssLink14;
        String url15 = MainActivity.sportsrssLinks.get(i).rssLink15;
