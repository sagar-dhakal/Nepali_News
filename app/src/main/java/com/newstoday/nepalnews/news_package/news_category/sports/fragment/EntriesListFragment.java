...
package com.newstoday.nepalnews.news_package.news_category.sports.fragment;
...
import com.newstoday.nepalnews.news_package.news_category.sports.adapter.EntriesCursorAdapter;
import com.newstoday.nepalnews.news_package.news_category.sports.provider.FeedData;
...
import com.newstoday.nepalnews.news_package.news_category.sports.service.FetcherService;
...
public class EntriesListFragment extends SwipeRefreshListFragment implements ViewTreeObserver.OnScrollChangedListener {
    ...
    public void inflateView(LayoutInflater inflater, ViewGroup container) {
        ...
        News_Sites_Adapter adapter = new News_Sites_Adapter(getActivity(), "sportsnewssites", MainActivity.topNewsSites, MainActivity.entertainmentnewssites, MainActivity.financenewssites, MainActivity.healthnewssites, MainActivity.politicsnewssites, MainActivity.sportsnewssites, MainActivity.technologynewssites,
