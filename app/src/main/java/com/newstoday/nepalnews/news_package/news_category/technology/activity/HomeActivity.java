...
package com.newstoday.nepalnews.news_package.news_category.technology.activity;
...
import com.newstoday.nepalnews.news_package.news_category.technology.fragment.EntriesListFragment;
import com.newstoday.nepalnews.news_package.news_category.technology.provider.FeedData.EntryColumns;
import com.newstoday.nepalnews.news_package.news_category.technology.provider.FeedData.FeedColumns;
import com.newstoday.nepalnews.news_package.news_category.technology.provider.FeedDataContentProvider;
import com.newstoday.nepalnews.news_package.news_category.technology.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_technology_view_home);
        ...
        String url1 = MainActivity.technologyrssLinks.get(i).rssLink1;
        String url2 = MainActivity.technologyrssLinks.get(i).rssLink2;
        String url3 = MainActivity.technologyrssLinks.get(i).rssLink3;
        String url4 = MainActivity.technologyrssLinks.get(i).rssLink4;
        String url5 = MainActivity.technologyrssLinks.get(i).rssLink5;
        String url6 = MainActivity.technologyrssLinks.get(i).rssLink6;
        String url7 = MainActivity.technologyrssLinks.get(i).rssLink7;
        String url8 = MainActivity.technologyrssLinks.get(i).rssLink8;
        String url9 = MainActivity.technologyrssLinks.get(i).rssLink9;
        String url10 = MainActivity.technologyrssLinks.get(i).rssLink10;
        String url11 = MainActivity.technologyrssLinks.get(i).rssLink11;
        String url12 = MainActivity.technologyrssLinks.get(i).rssLink12;
        String url13 = MainActivity.technologyrssLinks.get(i).rssLink13;
        String url14 = MainActivity.technologyrssLinks.get(i).rssLink14;
        String url15 = MainActivity.technologyrssLinks.get(i).rssLink15;
