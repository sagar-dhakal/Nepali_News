...
package com.newstoday.nepalnews.news_package.news_category.world.activity;
...
import com.newstoday.nepalnews.news_package.news_category.world.fragment.EntriesListFragment;
import com.newstoday.nepalnews.news_package.news_category.world.provider.FeedData.EntryColumns;
import com.newstoday.nepalnews.news_package.news_category.world.provider.FeedData.FeedColumns;
import com.newstoday.nepalnews.news_package.news_category.world.provider.FeedDataContentProvider;
import com.newstoday.nepalnews.news_package.news_category.world.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_world_view_home);
        ...
        String url1 = MainActivity.worldrssLinks.get(i).rssLink1;
        String url2 = MainActivity.worldrssLinks.get(i).rssLink2;
        String url3 = MainActivity.worldrssLinks.get(i).rssLink3;
        String url4 = MainActivity.worldrssLinks.get(i).rssLink4;
        String url5 = MainActivity.worldrssLinks.get(i).rssLink5;
        String url6 = MainActivity.worldrssLinks.get(i).rssLink6;
        String url7 = MainActivity.worldrssLinks.get(i).rssLink7;
        String url8 = MainActivity.worldrssLinks.get(i).rssLink8;
        String url9 = MainActivity.worldrssLinks.get(i).rssLink9;
        String url10 = MainActivity.worldrssLinks.get(i).rssLink10;
        String url11 = MainActivity.worldrssLinks.get(i).rssLink11;
        String url12 = MainActivity.worldrssLinks.get(i).rssLink12;
        String url13 = MainActivity.worldrssLinks.get(i).rssLink13;
        String url14 = MainActivity.worldrssLinks.get(i).rssLink14;
        String url15 = MainActivity.worldrssLinks.get(i).rssLink15;
