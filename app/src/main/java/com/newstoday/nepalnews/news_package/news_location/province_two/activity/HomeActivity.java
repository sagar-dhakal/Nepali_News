...
package com.newstoday.nepalnews.news_package.news_location.province_two.activity;
...
import com.newstoday.nepalnews.news_package.news_location.province_two.fragment.EntriesListFragment;
import com.newstoday.nepalnews.news_package.news_location.province_two.provider.FeedData.EntryColumns;
import com.newstoday.nepalnews.news_package.news_location.province_two.provider.FeedData.FeedColumns;
import com.newstoday.nepalnews.news_package.news_location.province_two.provider.FeedDataContentProvider;
import com.newstoday.nepalnews.news_package.news_location.province_two.utils.PrefUtils;
...
public class HomeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.p_two_view_home);
        ...
        String url1 = MainActivity.province2rssLinks.get(i).rssLink1;
        String url2 = MainActivity.province2rssLinks.get(i).rssLink2;
        String url3 = MainActivity.province2rssLinks.get(i).rssLink3;
        String url4 = MainActivity.province2rssLinks.get(i).rssLink4;
        String url5 = MainActivity.province2rssLinks.get(i).rssLink5;
        String url6 = MainActivity.province2rssLinks.get(i).rssLink6;
        String url7 = MainActivity.province2rssLinks.get(i).rssLink7;
        String url8 = MainActivity.province2rssLinks.get(i).rssLink8;
        String url9 = MainActivity.province2rssLinks.get(i).rssLink9;
        String url10 = MainActivity.province2rssLinks.get(i).rssLink10;
        String url11 = MainActivity.province2rssLinks.get(i).rssLink11;
        String url12 = MainActivity.province2rssLinks.get(i).rssLink12;
        String url13 = MainActivity.province2rssLinks.get(i).rssLink13;
        String url14 = MainActivity.province2rssLinks.get(i).rssLink14;
        String url15 = MainActivity.province2rssLinks.get(i).rssLink15;
