...
abstract class CursorLoaderExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    CursorLoaderExpandableListAdapter(Activity activity, Uri groupUri) {
        this(activity, groupUri, com.newstoday.nepalnews.R.layout.feed_item_feed_list, com.newstoday.nepalnews.R.layout.feed_item_feed_list, com.newstoday.nepalnews.R.layout.feed_item_feed_list);
    }
